    ...
    <footer>
        <div id="footer_content">
            ...
            <ul class="footer-list">
                ...
                <li>
                    <a href="" class="footer_link">Loja 1 - Avenida Presidente Kennedy 410, rebouças - Curitiba</a>
                </li>
                <li>
                    <a href="" class="footer_link">Loja 2 - Rua Saturnino Miranda, 84 - Santa Felicidade - Curitiba</a>
                </li>
            </ul>
            <ul class="footer-list">
                <li>
